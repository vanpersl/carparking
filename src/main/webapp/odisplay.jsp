...
<div id="outer-container">
	<div id="container">
		...
		<div id="content">
        	<div id="main">       
					<table align="center" title="计费">
						<tr>
							<td align="right">车牌号：</td>
							<td align="left"><font color="red"><s:property value="#request.outCarNo"/></font></td>
						</tr>
						<tr><td>&nbsp;</td></tr>
						<tr>
							<td align="right">停车时长：</td>
							<td align="left"><font color="red"><s:property value="#request.parkTime"/></font></td>
						</tr>
						<tr><td>&nbsp;</td></tr>
						<tr>
							<td align="right">应交费用：</td>
							<td align="left"><font color="red"><s:property value="#request.pkFee"/>&nbsp;元</font></td>
						</tr>	
						<s:if test="pkUn != 0">
						<tr><td>&nbsp;</td></tr>
						<tr>
						<td align="right">余额不足：</td>
							<td align="left">应补交[&nbsp;<font color="red"><s:property value="#request.pkUn"/>&nbsp;元]</font></td>
						</tr>		
						</s:if>					
					</table>                           
            	<div class="clear"></div><!-- clear float -->

...
<div id="outer-container">
	<div id="container">
		...
		<div id="content">
        	<div id="main">               
                <h2 class="title_pattern uppercase"><span>您的个人信息如下</span></h2>
                <table align="center">
                	<tr>
                		<td align="right">绑定车牌：</td>
                		<td align="left"><s:property value="#session.ui.userInfoCarno"/></td>
                	</tr>
                	<tr>
                		<td align="right">卡上余额：</td>
                		<td align="left"><s:property value="#session.uc.userCardBalance"/></td>
                	</tr>
                	<tr>
                		<td align="right">历史积分：</td>
                		<td align="left"><s:property value="#session.uc.userCardCost"/></td>
                	</tr>                	
                	<tr>
                		<td align="right">享受折扣：</td>
                		<td align="left"><s:property value="#session.uc.userCardDiscount"/></td>
                	</tr>
                	<tr>
                		<td align="right">申请时间：</td>
                		<td align="left"><s:property value="#session.uc.userCardHt"/></td>
                	</tr>
                	<tr>
                		<td align="right">卡状态：</td>
                		<td align="left"><s:property value="#session.uc.userCardStatus"/></td>
                	</tr>
                </table>
            	<div class="clear"></div>
            </div>

...
<s:if test="pageNow == null">
	<meta http-equiv="refresh" content="0;URL=ShowCeb.action?pageNow=1">
</s:if>
...
<div id="outer-container">
	<div id="container">
		...
		<div id="content">
        	<div id="main">               
                <h2 class="title_pattern uppercase"><span>当前所有停车场所停车辆</span></h2>
                <table align="center" id="tabfst">
					...
					<s:iterator value="ceb">
						<tr align="center">
							...
							<td width="13%"><s:property value="cpaEnterCarno"/></td>
							...
							<td width="10%"><s:property value="cpaEnterCarbz"/></td>
							<td width="12%"><s:property value="cpaEnterCpaname"/></td>
					    </tr>
					</s:iterator>
                </table>    
				...
				共<strong><s:property value="#request.intPageCount"/></strong>页
			                        <a href="ShowCeb.action?pageNow=1">首页</a>
			                        <a href="ShowCeb.action?pageNow=<s:property value='%{PageNow-1}'/>"> 上一页</a>
			                        <a href="ShowCeb.action?pageNow=<s:property value='%{PageNow+1}'/>">下一页</a>
			                        <a href="ShowCeb.action?pageNow=<s:property value='#request.intPageCount'/>">末页</a>

...
<s:if test="pageNow == null">
	<meta http-equiv="refresh" content="0;URL=ShowAdmRecord.action?pageNow=1">
</s:if>
...
<div id="outer-container">
	<div id="container">
		...
		<div id="content">
        	<div id="main">               
                <h2 class="title_pattern uppercase"><span>员工上、下线记录</span></h2>
                <table align="center" id="tabfst">
                	<tr align="center">
						<td width="10%">姓名</td>
						<td width="18%">上线时间</td>
						<td width="18%">下线时间</td>
						<td width="14%">办理业务个数</td>
						<td width="12%">收取现金</td>
						<td width="14%">所属停车场</td>
						<td width="14%">在线时长</td>
					</tr>
					<s:iterator value="aab">
						<tr align="center">
							<td width="10%"><s:property value="adminArchName"/></td>
							<td width="18%"><s:property value="adminArchLt"/></td>
							<td width="18%"><s:property value="adminArchOt"/></td>
							<td width="14%"><s:property value="adminArchNo"/></td>
							<td width="12%"><s:property value="adminArchFee"/></td>
							<td width="14%"><s:property value="adminArchCpaname"/></td>
							<td width="14%"><s:property value="adminArchWorktime"/></td>
					    </tr>
					</s:iterator>
                </table>    
				...
				共<strong><s:property value="#request.intPageCount"/></strong>页
			                        <a href="ShowAdmRecord.action?pageNow=1">首页</a>
			                        <a href="ShowAdmRecord.action?pageNow=<s:property value='%{PageNow-1}'/>"> 上一页</a>
			                        <a href="ShowAdmRecord.action?pageNow=<s:property value='%{PageNow+1}'/>">下一页</a>
			                        <a href="ShowAdmRecord.action?pageNow=<s:property value='#request.intPageCount'/>">末页</a>

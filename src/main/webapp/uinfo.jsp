...
<div id="outer-container">
	<div id="container">
		...
		<div id="content">
        	<div id="main">               
                <h2 class="title_pattern uppercase"><span>查看您的注册信息</span></h2>
                	<table align="center">	
                			<tr>
			                    <td align="right">电子计费卡卡号：</td>
			                    <td><font color="blue"><s:property value="#request.cardNo"/></font></td>
			                </tr>
			                <tr><td>&nbsp;</td></tr>		               
			                <tr>
			                    <td align="right">用户名：</td>
			                    <td><font color="blue"><s:property value="#request.name"/></font></td>
			                </tr>
			                <tr><td>&nbsp;</td></tr>
			                <tr>
			                ...
			                <tr>
			                    ...
			                    <td><font color="blue"><s:property value="#request.carno"/></font></td>
			                </tr>
			                <tr><td>&nbsp;</td></tr>
			                <tr>
			                    <td align="right">联系电话：</td>
			                    <td><font color="blue"><s:property value="#request.tel"/></font></td>
			                </tr>
			                <tr><td>&nbsp;</td></tr>
			                <tr>
			                    <td align="right">住址：</td>
			                    <td><font color="blue"><s:property value="#request.address"/></font></td>
			                </tr>
			                <tr><td>&nbsp;</td></tr>
			                <tr>
			                    <td align="right">姓别：</td>
			                    <td><font color="blue"><s:property value="#request.sex"/></font></td>
			                </tr>
			                <tr><td>&nbsp;</td></tr>			                			                		                
			            </table>                   
            	<div class="clear"></div>

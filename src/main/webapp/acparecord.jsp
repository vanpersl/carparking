...
<s:if test="pageNow == null">
	<meta http-equiv="refresh" content="0;URL=RecordPage.action?pageNow=1">
</s:if>
...
<div id="outer-container">
	<div id="container">
		...
		<div id="content">
        	<div id="main">               
                <h2 class="title_pattern uppercase"><span>历史停车记录</span></h2>
                <table id="tabfst" align="center" title="所有停车场的历史停车记录">
					...
					<s:iterator value="cpb">
						<tr align="center">
							...
							<td width="7%"><s:property value="cpaRecordCarbz"/></td>
					    </tr>
					</s:iterator>
				</table>
				<br/>
				...
				共<strong><s:property value="#request.intPageCount"/></strong>页
			                        <a href="RecordPage.action?pageNow=1">首页</a>
			                        <a href="RecordPage.action?pageNow=<s:property value='%{PageNow-1}'/>"> 上一页</a>
			                        <a href="RecordPage.action?pageNow=<s:property value='%{PageNow+1}'/>">下一页</a>
			                        <a href="RecordPage.action?pageNow=<s:property value='#request.intPageCount'/>">末页</a>

...
<s:if test="pageNow == null">
	<meta http-equiv="refresh" content="0;URL=ShowRecRecord.action?pageNow=1">
</s:if>
...
<div id="outer-container">
	<div id="container">
		...
		<div id="content">
        	<div id="main">               
                <h2 class="title_pattern uppercase"><span>充值记录</span></h2>
                <table align="center" id="tabfst">
					...
					<s:iterator value="ccb">
						<tr align="center">
							<td width="25%"><s:property value="cardRechargeNo"/></td>
							<td width="25%"><s:property value="cardRechargeNum"/></td>
							<td width="25%"><s:property value="cardRechargeOpt"/></td>				
							<td width="25%"><s:property value="cardRechargeTime"/></td>
					    </tr>
					</s:iterator>
                </table>    
				...
				共<strong><s:property value="#request.intPageCount"/></strong>页
			                        <a href="ShowRecRecord.action?pageNow=1">首页</a>
			                        <a href="ShowRecRecord.action?pageNow=<s:property value='%{PageNow-1}'/>"> 上一页</a>
			                        <a href="ShowRecRecord.action?pageNow=<s:property value='%{PageNow+1}'/>">下一页</a>
			                        <a href="ShowRecRecord.action?pageNow=<s:property value='#request.intPageCount'/>">末页</a>

...
<div id="outer-container">
	<div id="container">
		...
		<div id="content">
        	<div id="main">               
                <h2 class="title_pattern uppercase"><span>删除该员工账号</span></h2>
                <s:form action="DelAdmin.action">
                	<table align="center">
                		<tr>
                			<td align="right">登录账号：</td>
                			<td align="left"><input type="text" name="adminName"/></td>
                		</tr>
                		<tr>
                			<td>&nbsp;</td>
                		</tr>
                		<tr>
                			<td>&nbsp;</td>
                			<td align="left"><input type="submit" value="删除" /></td>
                		</tr>
                	</table>
                </s:form>                         
            	<div class="clear"></div>

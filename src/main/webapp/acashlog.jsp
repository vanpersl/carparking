...
<div id="outer-container">
	<div id="container">
		...
		<div id="content">
        	<div id="main">               
                <h2 class="title_pattern uppercase"><span><a href="ShowCash.action">显示收取现金记录</a></span></h2>
                <font color="blue">
                <table align="center">
                	<tr align="center">
						<td width="50%">姓名</td>
					...
					<s:iterator value="cb">
						<tr align="center">
							...
							<td width="50%"><s:property value="num"/></td>
					    </tr>
					</s:iterator>
                </table>
                </font>                              
                        ...
                        <li class="widget-container">
                            ...
                            <marquee scrollAmount=2 width=200 height=130 direction=up onmouseover=this.stop() onmouseout=this.start() >
								<s:iterator value="#session.newsList">
									<div><a href="Newfw.action?uid=<s:property value="id"/>"><s:property value="title"/></a></div>
								</s:iterator>
							</marquee>
                        </li>
                    </ul>

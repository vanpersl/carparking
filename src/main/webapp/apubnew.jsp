...
<div id="outer-container">
	<div id="container">
		...
		<div id="content">
        	<div id="main">               
                <h2 class="title_pattern uppercase"><span>系统公告发布</span></h2>
                <div id="contactform">
                	<s:form action="PublishNews.action" method="post" enctype="multipart/form-data">
                	<table width="550px;" align="center">
                		<tr align="left">
                			<td>新闻标题:</td>
                		</tr>
                		<tr align="left">
                			<td><input type="text" name="title" style="width: 180px;"  maxlength="50"/></td>
                		</tr>
                		<tr align="left">
                			<td>内容:</td>
                		</tr>
                		<tr align="left">
                			<td><textarea cols="60" rows="10" name="msg" ></textarea></td>
                		</tr> 
                		<tr align="left">
                			<td>附件:</td>
                		</tr>          	
                		<tr align="left">              	
                			<td>		                     
                			<input type="text" name="atatach"/><br/>              	                   
                      		</td>             
                    	</tr>
                    	<tr>
                			<td>		                     
                			<input type="submit" name="submit" class="butcontact" id="submit_btn" value="发   布"/>             	                   
                      		</td> 
                    	</tr>
                    </table>
                    </s:form>

...
<div id="outer-container">
	<div id="container">
		...
		<div id="content">
        	<div id="main">               
                <h2 class="title_pattern uppercase"><span>新添加员工信息</span></h2><font color="blue">
                   <s:form action="AddAdmin.action">
						<table align="center"title="添加管理员">
							<tr>
								<td align="right">管理员登录账号:</td>
							...
							<tr>
								...
								<td><select name="cpaname">
										<s:iterator value="#session.cpaname">
											<option value="<s:property value="cpaParamName"/>"><s:property value="cpaParamName"/></option>					
										</s:iterator>
									</select>
								</td>
							</tr>					
							...
							<tr align="center">
								<td></td>
								<td><input type="submit" value="注  册"/>&nbsp;&nbsp;<input type="reset" value="清  空"/></td>							
							</tr>
						</table>
					</s:form></font>                        
            	<div class="clear"></div>

...
<div id="outer-container">
	<div id="container">
		...
		<div id="content">
        	<div id="main">               
                <h2 class="title_pattern uppercase"><span><s:property value="cpaEnterCpaname"/>当前车辆停放信息</span></h2>
                <s:form action="ShowOneCeb.action">
	                <table align="center">
	                	<tr>
	                		<td align="left">停车场名:</td>
	                		<td align="center"><input type="text" name="cpaName"/></td>
	                		<td align="right">&nbsp;&nbsp;<input type="submit" value="查  询"/></td>
	                	</tr>
	                </table>
                </s:form>  
